...
//
// The general approach zwo takes, is to disallow everything, but the stuff explicitly allowed. IPTables works by
...
// takes effect. This is set to "DROP" in zwo.
//
...
//
// zwo has a host mode regarding firewall named "paranoid". This is a setting where outgoing traffic must be explicitly
...
//
// TODO(gfrey): Write about how rules are configured in zwo. Have some nice examples.
package fw
